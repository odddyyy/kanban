...
var _default = {
  ...
  methods: {
    postLogin: function postLogin() {
      ...
      _axios.default.post("https://protected-crag-71554.herokuapp.com/users/login", {
        ...
        _this.$emit('changeIsLogin', {
          value: true
        });
      }).catch(function (err) {
        _this.error_msg = err.response.data;
        _this.error = true;
      });
    }
  }
...
exports.default = _default;
        var $e18549 = exports.default || module.exports;
      
      if (typeof $e18549 === 'function') {
        $e18549 = $e18549.options;
      }
    
        /* template */
        Object.assign($e18549, (function () {
          var render = function() {
  var _vm = this
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "sidenav" }, [
      _c("div", { staticClass: "login-main-text" }, [
        _c("h2", [_vm._v("Application"), _c("br"), _vm._v(" Login Page")]),
        _vm._v(" "),
        _c("p", [_vm._v("Login or register from here to access.")])
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e18549', $e18549);
          } else {
            api.reload('$e18549', $e18549);
          }
        }
...
},{"axios":"node_modules/axios/index.js","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/add.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $7d965d = exports.default || module.exports;
      
      if (typeof $7d965d === 'function') {
        $7d965d = $7d965d.options;
      }
    
        /* template */
        Object.assign($7d965d, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$7d965d', $7d965d);
          } else {
            api.reload('$7d965d', $7d965d);
          }
        }
  ...
  methods: {
    getData: function getData() {
      ...
      (0, _axios.default)({
        ...
        _this.listTask = data.data;

        _this.filter();
      }).catch(function (err) {});
    },
    filter: function filter() {
      this.listTask.sort(function (a, b) {
        return a.id - b.id;
      });
      this.backlog = this.listTask.filter(function (i) {
        return i.status == "Backlog";
      });
      this.onProcess = this.listTask.filter(function (i) {
        return i.status == "On Process";
      });
      this.onReviewed = this.listTask.filter(function (i) {
        return i.status == "On Reviewed";
      });
      this.completed = this.listTask.filter(function (i) {
    ...
    changeStatsNext: function changeStatsNext(id, status) {
      ...
      (0, _axios.default)({
        method: 'PUT',
        url: "https://protected-crag-71554.herokuapp.com/tasks/edit/".concat(id),
        headers: {
          access_token: localStorage.access_token
        },
        data: {
    ...
    deleteTask: function deleteTask(id) {
      ...
      (0, _axios.default)({
        method: 'DELETE',
        url: "https://protected-crag-71554.herokuapp.com/tasks/delete/".concat(id),
        headers: {
          access_token: localStorage.access_token
        }
      }).then(function (data) {
...
exports.default = _default;
        var $9fd0ee = exports.default || module.exports;
      
      if (typeof $9fd0ee === 'function') {
        $9fd0ee = $9fd0ee.options;
      }
    
        /* template */
        Object.assign($9fd0ee, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
            ...
            [
              _c(
                ...
                [
                  _c(
                    "h3",
                    {
                      staticStyle: { "font-family": "fantasy", color: "white" }
                    },
                    [_vm._v("BACKLOG")]
                  ),
                  _vm._v(" "),
                  _vm._l(_vm.backlog, function(list) {
                    return _c(
                      "div",
                      { key: list.id, staticClass: "row-12 mt-2" },
                      [
                        _c("div", { staticClass: "card shadow-lg rounded" }, [
                          _c("div", { staticClass: "card-body" }, [
                            ...
                            _c("hr"),
                            _vm._v(" "),
                            _c("p", [_vm._v(_vm._s(list.description))])
                          ]),
                          _vm._v(" "),
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.onProcess, function(list) {
                    return _c(
                      "div",
                      { key: list.id, staticClass: "row-12 mt-2" },
                      [
                        _c("div", { staticClass: "card" }, [
                          ...
                          _c("div", { staticClass: "card-text mt-1" }, [
                            _c(
                              "button",
                              {
                                staticClass: "btn btn-danger mb-1 mt-1",
                                on: {
                                  click: function($event) {
                                    $event.preventDefault()
                                    return _vm.changeStatsBack(
                                      list.id,
                                      list.status
                                    )
                                  }
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.onReviewed, function(list) {
                    return _c(
                      "div",
                      { key: list.id, staticClass: "row-12 mt-2" },
                      [
              ...
              _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _vm._l(_vm.completed, function(list) {
                    return _c(
                      "div",
                      { key: list.id, staticClass: "row-12 mt-2" },
                      [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9fd0ee', $9fd0ee);
          } else {
            api.reload('$9fd0ee', $9fd0ee);
          }
        }
...
var _kanbanTable = _interopRequireDefault(require("./components/kanbanTable"));
...
var _default = {
  components: {
    ...
    KanbanTable: _kanbanTable.default
  },
  data: function data() {
    return {
      isLogin: null,
...
exports.default = _default;
        var $d90896 = exports.default || module.exports;
      
      if (typeof $d90896 === 'function') {
        $d90896 = $d90896.options;
      }
    
        /* template */
        Object.assign($d90896, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d90896', $d90896);
          } else {
            api.reload('$d90896', $d90896);
          }
        }
...
},{"axios":"node_modules/axios/index.js","./components/login":"src/components/login.vue","./components/kanbanTable":"src/components/kanbanTable.vue","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
